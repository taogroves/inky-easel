...
export default function InboxList({ frameId, items: initial }: { frameId: string; items: InboxItem[] }) {
          ...
          <div className="flex items-baseline justify-between gap-3">
            <div>
              <div className="text-xs text-ink-soft">
                {item.sender_label || "Anonymous"} - {new Date(item.created_at).toLocaleString()}
